...
module ILoveVideoEditor
  class QueueRenderRequest < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ILoveVideoEditor::QueueRenderRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ILoveVideoEditor::QueueRenderRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @video_json.nil?
        invalid_properties.push('invalid value for "video_json", video_json cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @video_json.nil?
      true
    end

    # Custom attribute writer method with validation
    # @param [Object] video_json Value to be assigned
    def video_json=(video_json)
      if video_json.nil?
        fail ArgumentError, 'video_json cannot be nil'
      end
    ...
    def hash
      [video_json, webhook_url, project_id].hash
    end
