...
module ILoveVideoEditor
  class BillingSubscription < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ILoveVideoEditor::BillingSubscription` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ILoveVideoEditor::BillingSubscription`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'credits_total')
        self.credits_total = attributes[:'credits_total']
      else
        self.credits_total = nil
      end
    ...
    def list_invalid_properties
      ...
      if @credits_total.nil?
        invalid_properties.push('invalid value for "credits_total", credits_total cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @credits_total.nil?
    ...
    # Custom attribute writer method with validation
    # @param [Object] credits_total Value to be assigned
    def credits_total=(credits_total)
      if credits_total.nil?
        fail ArgumentError, 'credits_total cannot be nil'
      end
    ...
    def hash
      [status, current_period_end, credits_balance, credits_total, tier].hash
    end
