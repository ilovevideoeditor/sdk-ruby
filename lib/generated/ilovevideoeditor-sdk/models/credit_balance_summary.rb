...
module ILoveVideoEditor
  class CreditBalanceSummary < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ILoveVideoEditor::CreditBalanceSummary` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ILoveVideoEditor::CreditBalanceSummary`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'consumed30_days')
        self.consumed30_days = attributes[:'consumed30_days']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          consumed == o.consumed &&
          refunded == o.refunded &&
          consumed30_days == o.consumed30_days
    end
    ...
    def hash
      [purchased, consumed, refunded, consumed30_days].hash
    end
